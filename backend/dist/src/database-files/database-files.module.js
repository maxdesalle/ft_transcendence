...
const database_files_controller_1 = require("./database-files.controller");
let DatabaseFilesModule = class DatabaseFilesModule {
};
DatabaseFilesModule = __decorate([
    (0, common_1.Module)({
        providers: [database_files_service_1.DatabaseFilesService],
        imports: [typeorm_1.TypeOrmModule.forFeature([databaseFile_entity_1.DatabaseFile])],
        exports: [database_files_service_1.DatabaseFilesService],
        controllers: [database_files_controller_1.DatabaseFilesController]
    })
], DatabaseFilesModule);
